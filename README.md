...
Los códigos de paquetes se validan con el prefijo **JPE** tanto en la aplicación como en Supabase. Si el Administrador necesita corregir una OT, guía, saco, costal, paquete, saco vacío o precinto, puede abrir el detalle del registro y utilizar **Editar información registrada**. Las correcciones se guardan en `auditoria_cambios` y se muestran en el campo **Resumen de cambios administrativos** con fecha, usuario, campo, valor anterior y valor nuevo.
